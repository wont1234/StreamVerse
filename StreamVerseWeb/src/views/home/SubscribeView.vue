    ...
    <div v-else>
        ...
        <v-row align="center" class="mb-2">
          <v-col cols="12">
            <div class="d-flex align-center">
              <v-icon icon="mdi-youtube-subscription" color="primary" size="32" class="mr-3"></v-icon>
      ...
      <v-container>
        <v-row>
          <v-col cols="12">
            ...
            <!-- 关注用户加载状态 -->
            <v-card v-if="loadingUsers" variant="flat" class="mb-4 py-6 bg-surface">
            ...
            <v-card
              ...
              variant="flat"
              class="mb-4 pa-6 bg-surface"
            >
              <div class="text-center">
                <v-avatar class="mb-4 bg-surface" size="80">
      ...
      <v-container>
        ...
        <v-sheet
          ...
          class="pa-8 text-center rounded-lg bg-surface"
        >
